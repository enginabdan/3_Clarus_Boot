...
CREATE TABLE Staff (StaffID INT IDENTITY(10, 1),
...
CREATE TABLE Student (StudentID INT IDENTITY(20, 1),
					  FirstName nVARCHAR(50) NOT NULL,
					  LastName nVARCHAR(50) NOT NULL,
...
CREATE TABLE Course (CourseID INT IDENTITY(30, 1),
...
CREATE TABLE Enrollment (StudentID INT  NOT NULL,
...
CREATE TABLE StaffCourse (StaffID INT NOT NULL,
						  CourseID INT NOT NULL, 
...
BEGIN
	DECLARE @REJECT int
	IF EXISTS (SELECT 1
			   FROM	(SELECT	B.StudentID, sum(Credit) sum_credit
					 FROM	Course A 
