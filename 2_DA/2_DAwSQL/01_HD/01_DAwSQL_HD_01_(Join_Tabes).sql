...
SELECT	TOP 20 A.product_id, product_name, B.category_id, category_name
...
SELECT TOP 20 A.product_id, product_name, B.store_id, quantity
FROM	production.products A
...
SELECT TOP 20 B.product_id, product_name, A.store_id, quantity
...
SELECT A.*, B.staff_id, first_name, last_name
FROM	sales.orders A
